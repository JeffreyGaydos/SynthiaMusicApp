...
function PlaylistItem({ imageSrc, title, stats, navigation }: { imageSrc: string[], title: string, stats: playlist_stats, navigation: any}) {
    ...
    return (
        ...
        >
            ...
            <View style={s_playlist_item.details_wrapper}>
            ...
            <View style={s_playlist_item.operations_wrapper}>
                <Icon style={s_playlist_item.operations_icons} name="shuffle" size={30}></Icon>
                <Icon style={s_playlist_item.operations_icons} name="loop" size={30}></Icon>
            </View>
        </View>
    );
}
